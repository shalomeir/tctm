...
public class Noop extends Pipe implements Serializable
{
	...
	*/
    ...
    public Noop (Alphabet dataDict,
                 Alphabet targetDict, Alphabet tag1Dict, Alphabet tag2Dict, Alphabet tag3Dict, Alphabet tag4Dict, Integer lines)
    {
        super (dataDict, targetDict, tag1Dict, tag2Dict, tag3Dict, tag4Dict, lines);
    }
