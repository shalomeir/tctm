...
public class ParallelTopicModel_origin implements Serializable {

	public static final int UNASSIGNED_TOPIC = -1;

	public static Logger logger = MalletLogger.getLogger(ParallelTopicModel_origin.class.getName());
	...
	public ParallelTopicModel_origin (int numberOfTopics) {
		this (numberOfTopics, numberOfTopics, DEFAULT_BETA);
	}
	
	public ParallelTopicModel_origin (int numberOfTopics, double alphaSum, double beta) {
	...
	public static ParallelTopicModel_origin read (File f) throws Exception {

		ParallelTopicModel_origin topicModel = null;

		ObjectInputStream ois = new ObjectInputStream (new FileInputStream(f));
		topicModel = (ParallelTopicModel_origin) ois.readObject();
		ois.close();
	...
	public static void main (String[] args) {
		...
		try {
			...
			ParallelTopicModel_origin lda = new ParallelTopicModel_origin (numTopics, 50.0, 0.01);
