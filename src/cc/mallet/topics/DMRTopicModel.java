...
import edu.kaist.irlab.sglee.util.CurrentTimeWriter;
...
public class DMRTopicModel extends LDAHyper {
	...
	public static void main (String[] args) throws IOException {
        ...
        InstanceList testing =
            args.length > 3 ? InstanceList.load (new File(args[3])) : null;

        DMRTopicModel lda = new DMRTopicModel (numTopics);
		lda.setOptimizeInterval(100);
		lda.setTopicDisplay(100, 10);
		lda.addInstances(training);
		lda.estimate(100); // test
//        lda.estimate();

		lda.writeParameters(new File(args[2]+"_parameters.txt"));
//		lda.printState(new File(args[2]+"_state.state.gz"));
        lda.printTopWords(new File(args[2]+"_topWords.csv"), 1000, false);
//		lda.printTopWordsExcel("data/output/reformPOIModel/"+experimentName+"_TopWordsExcel/","_tnum"+ numTopics +"_"+CurrentTimeWriter.CurrentTimeNameWriter()+".csv", 1000, true);
//        lda.printTopWordsExcelOne("data/output/reformPOIModel/TopWordsExcel_"+experimentName+"_tnum"+ numTopics +"_"+CurrentTimeWriter.CurrentTimeNameWriter()+".csv", 1000, true);
//        lda.printDocumentTopics(new File(args[2]+"_doc-topics.csv"));
        lda.printDocumentTopicsSvmStyle(new File(args[2]+"_doc-topics-counts.txt"));

//        lda.topicXMLReport(new File(args[3]+"_topicReport.xml"),100);
//		lda.writeParametersExcel("data/output/reformPOIModel/"+experimentName+"_ParametersExcel/","_tnum"+ numTopics +"_"+CurrentTimeWriter.CurrentTimeNameWriter()+".csv");
//        lda.writeParametersExcelOne("data/output/reformPOIModel/TopicFeaturesExcel_"+experimentName+"_tnum"+ numTopics +"_"+CurrentTimeWriter.CurrentTimeNameWriter()+".csv");
//        lda.printFeatureWordsExcelOne("data/output/reformPOIModel/FeatureWordsExcel_"+experimentName+"_tnum"+ numTopics +"_"+CurrentTimeWriter.CurrentTimeNameWriter()+".csv", 1000, true);
