 ...
 * using {@link cc.mallet.cluster.neighbor_evaluator.NeighborEvaluator}.
 *
 * Differs from {@link cc.mallet.cluster.GreedyAgglomerative} in that one cluster is
 ...
 * @version 1.0
 * @since 1.0
 * @see cc.mallet.cluster.GreedyAgglomerative
 */
public class GreedyAgglomerativeByDensity extends GreedyAgglomerative {
	...
	/**
	 *
	 * @param instancePipe Pipe for each underying {@link cc.mallet.types.Instance}.
