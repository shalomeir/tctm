 ...
 * variance. It uses a given {@link cc.mallet.types.Metric} to find the distance between
 * {@link cc.mallet.types.Instance}s, which should have {@link cc.mallet.types.SparseVector}s in the data
 * field.
 * 
 */
