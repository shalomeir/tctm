 ...
 * a {@link cc.mallet.cluster.neighbor_evaluator.NeighborEvaluator}.
 *
 * @author "Aron Culotta" <culotta@degas.cs.umass.edu>
 * @version 1.0
 * @since 1.0
 * @see cc.mallet.cluster.Clusterer
 */
public abstract class HillClimbingClusterer extends KBestClusterer {
	 ...
	 * current predicted {@link cc.mallet.cluster.Clustering}.
	 * 
	 * @param instances
	 * @return The predicted {@link cc.mallet.cluster.Clustering}.
	 */
	 ...
	 * modify the current predicted {@link cc.mallet.cluster.Clustering}.
