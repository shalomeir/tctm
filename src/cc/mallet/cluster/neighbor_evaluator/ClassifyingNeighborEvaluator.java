...
/**
 * A {@link cc.mallet.cluster.neighbor_evaluator.NeighborEvaluator} that is backed by a {@link
 * Classifier}. The score for a {@link cc.mallet.cluster.neighbor_evaluator.Neighbor} is the Classifier's
 * predicted value for the label corresponding to <code>scoringLabel</code>.
 *
 * @author "Aron Culotta" <culotta@degas.cs.umass.edu>
 * @version 1.0
 * @since 1.0
 * @see cc.mallet.cluster.neighbor_evaluator.NeighborEvaluator
 */
public class ClassifyingNeighborEvaluator implements NeighborEvaluator, Serializable {

	/**
	 * The Classifier used to assign a score to each {@link cc.mallet.cluster.neighbor_evaluator.Neighbor}.
	 */
	...
	/**
	 *
	 * @param classifier The Classifier used to assign a score to each {@link cc.mallet.cluster.neighbor_evaluator.Neighbor}.
