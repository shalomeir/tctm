...
public class ClusterUtils {
	 ...
	 * @param li
	 * @param lj
	 * @return A new {@link cc.mallet.types.InstanceList} where <code>lj</code> is appended to <code>li</code>.
	 */
	 ...
	 * cc.mallet.types.Instance}s <code>i</code> and <code>j</code> have been put in the
	 * same cluster.
	 */
	 ...
	 * clusters containing the specified {@link cc.mallet.types.Instance}s have been
