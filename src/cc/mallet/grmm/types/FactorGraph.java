...
public class FactorGraph implements Factor {
  ...
  /**
	 ...
	 *  graphical model.
	 * @see cc.mallet.grmm.types.Assignment
	 */
  ...
  public int getIndex (Factor factor)
	 ...
	 *  <tt>idx == getIndex (var)</tt>, then <tt>get(idx)</tt> will
	 *  return <tt>var</tt>.
	 *  @see #getIndex(cc.mallet.grmm.types.Variable)
	 */
   ...
   * @see #addFactor(cc.mallet.grmm.types.Factor)
   * @see #factorOf(cc.mallet.grmm.types.Variable, cc.mallet.grmm.types.Variable)
   * @see #factorOf(cc.mallet.grmm.types.Variable)
   */
...
* where C ranges over all cliques for which factors have been defined.
   ...
   *    (such as by {@link #addFactor(cc.mallet.grmm.types.Factor)}).  Returns null if
   ...
   * @see #addFactor(cc.mallet.grmm.types.Factor)
   * @see #factorOf(cc.mallet.grmm.types.VarSet)
   */
